...
valid_states_rain.columns = ['State','Year','Rainfall'] #it finally contain state at some year and it's annual rainfall for that year
...
# print(type(potato_data))
# plt.scatter(potato_data['Production'],potato_data['Rainfall'])

def getData(cropname):
    return crop_data_alpha[crop_data_alpha['Crop']== cropname].to_numpy().tolist()
